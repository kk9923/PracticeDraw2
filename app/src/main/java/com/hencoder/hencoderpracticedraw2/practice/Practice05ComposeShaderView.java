...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader batman_logoShader = new BitmapShader(batman_logo, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shader = new ComposeShader(batmanShader,batman_logoShader, PorterDuff.Mode.DST_IN);
